...
let durationBtn = document.getElementById('durationBtn');
...
durationBtn.addEventListener('click', function () {
  ...
  if (duration) {
    chrome.storage.sync.set({ 'minDuration': duration });

    durationInput.value = '设置完成';
  }
});
...
document.getElementById('keywordManagement').addEventListener('click', function () {
  document.getElementById('keywordManagementSection').classList.remove('is-hidden');
});
document.getElementById('userManagement').addEventListener('click', function () {
  document.getElementById('keywordManagementSection').classList.add('is-hidden');
});
